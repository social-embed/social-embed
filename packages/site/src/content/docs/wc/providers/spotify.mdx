...
| Embed URL | `https://embed.spotify.com/{type}/{id}` |

Supported content types: **track**, **album**, **playlist**, **artist**, **show**, **episode**.
...
<o-embed url="spotify:track:1w4etUoKfql47wtTFq031f" spotify-size="compact"></o-embed>

<!-- Large album player -->
<o-embed url="spotify:album:4hg4cR8QMbE0xuvoxoA6DX" spotify-size="large"></o-embed>
```
...
```html
<o-embed url="spotify:album:4hg4cR8QMbE0xuvoxoA6DX" spotify-theme="light"></o-embed>
```
...
```html
<o-embed url="spotify:album:4hg4cR8QMbE0xuvoxoA6DX" spotify-view="coverart"></o-embed>
```
...
<o-embed url="spotify:episode:0Bx6gWK755bUoM238X2Ma1" spotify-start="120"></o-embed>
```
...
<o-embed url="spotify:album:4hg4cR8QMbE0xuvoxoA6DX" spotify-size="compact" spotify-theme="dark" spotify-view="coverart"></o-embed>
