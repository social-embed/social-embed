...
See the [web component docs](/wc/) for [attributes and styling](/wc/configuration/attributes-and-styling), [framework setup](/wc/framework-usage), and per-provider examples.
